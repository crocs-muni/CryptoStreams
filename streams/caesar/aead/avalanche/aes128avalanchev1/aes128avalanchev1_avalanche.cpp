...
//-------------------------------------------------------------------------------
/*----------------- Header Files --------------------------*/
#include "aes128avalanchev1_avalanche.h"

// CHANGE namespace moved due to include
namespace Aes128avalanchev1_raw {
int numRounds = -1;
        ...
        unsigned char *r, unsigned char *PCMACKey)
{
    ...
    for (j = 0; j < numOfChunks; j++)
    {
        ...
        AES_set_encrypt_key(finalKey, 128, &key);
        ...
        unsigned char *PCMACKey)
{
    ...
    for (j = 0; j < numOfChunks; j++) //decryption process
    {
        ...
        AES_set_decrypt_key(finalKey, 128, &key);
