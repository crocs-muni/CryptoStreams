...
//  -----------------------------------------------------------------------------
//
//           Description: PRIMATEs v1 - Gibbon-120 instantiation.
//
...
#include "primatesv1gibbon120_primate.h"
#include "primatesv1gibbon120_parameters.h"
#include <stdlib.h>
...
int crypto_aead_encrypt(
 ...
 )
 {
    ...
    p_1(V);
    // V <--  V_r || ( K || 0 ) ^ V_c
    for(int i=0; i<CapacitySize/2; i++)
        V[RateSizeElements+i]^=key[i];
