#include "proest128otrv1_proest128.h"
...
void ShiftRegisters(proest_ctx *x, int round)
{
  ...
  {
    x->a[1][0] = RORLANE(x->a[1][0],2);
    x->a[1][1] = RORLANE(x->a[1][1],2);
    x->a[1][2] = RORLANE(x->a[1][2],2);
    x->a[1][3] = RORLANE(x->a[1][3],2);

    x->a[2][0] = RORLANE(x->a[2][0],4);
    x->a[2][1] = RORLANE(x->a[2][1],4);
    x->a[2][2] = RORLANE(x->a[2][2],4);
    x->a[2][3] = RORLANE(x->a[2][3],4);

    x->a[3][0] = RORLANE(x->a[3][0],6);
    x->a[3][1] = RORLANE(x->a[3][1],6);
    x->a[3][2] = RORLANE(x->a[3][2],6);
    x->a[3][3] = RORLANE(x->a[3][3],6);
  }
  else
  {
    x->a[1][0] = RORLANE(x->a[1][0],1);
    x->a[1][1] = RORLANE(x->a[1][1],1);
    x->a[1][2] = RORLANE(x->a[1][2],1);
    x->a[1][3] = RORLANE(x->a[1][3],1);

    x->a[2][0] = RORLANE(x->a[2][0],8);
    x->a[2][1] = RORLANE(x->a[2][1],8);
    x->a[2][2] = RORLANE(x->a[2][2],8);
    x->a[2][3] = RORLANE(x->a[2][3],8);

    x->a[3][0] = RORLANE(x->a[3][0],9);
    x->a[3][1] = RORLANE(x->a[3][1],9);
    x->a[3][2] = RORLANE(x->a[3][2],9);
    x->a[3][3] = RORLANE(x->a[3][3],9);
  }
}
