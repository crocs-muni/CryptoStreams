// 64-bit version of Pi64Cipher128
// implementation of the algorithm with 64-bit registers and security of 128-bits
// bitrate is 512-bits, capacity is 512-bits -> state of the permutation function is 1024 bits long
// key is 128 bits, PMN is 128 bits, SMN is 512 bits and the tag is 512 bits
/*
 *
...
#include <stdio.h>
#include "pi64cipher128v1_api.h"

// CHANGE namespace moved due to includes
namespace Pi64cipher128v1_raw {
int numRounds = -1;
