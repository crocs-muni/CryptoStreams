...
/* little endian load of len bytes into least significant bits of the resulting value */
...
void initState(ICESTATE S, const unsigned char * k, const unsigned char * nonce)
{
    ICESTATE T;
