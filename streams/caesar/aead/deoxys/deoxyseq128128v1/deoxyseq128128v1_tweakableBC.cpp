...
void G (uint8_t tweakey[], uint8_t alpha) {
  int i;
  for(i=0; i<16; i++) tweakey[i] = multi (tweakey[i], alpha);
}
...
void H (uint8_t tweakey[]) {
  int i;
  uint8_t tmp[16];
  for( i = 0; i<16; i++) tmp[perm[i]] = tweakey[i];
                         ...
                         int no_tweakeys)
{
    ...
    for (i = 1; i <= Nr; i++) {
        rtweakey += 4;
        rtweakey[0] =
            Td0[Te4[(rtweakey[0] >> 24)       ] & 0xff] ^
            Td1[Te4[(rtweakey[0] >> 16) & 0xff] & 0xff] ^
            Td2[Te4[(rtweakey[0] >>  8) & 0xff] & 0xff] ^
            Td3[Te4[(rtweakey[0]      ) & 0xff] & 0xff];
        rtweakey[1] =
            Td0[Te4[(rtweakey[1] >> 24)       ] & 0xff] ^
            Td1[Te4[(rtweakey[1] >> 16) & 0xff] & 0xff] ^
            Td2[Te4[(rtweakey[1] >>  8) & 0xff] & 0xff] ^
            Td3[Te4[(rtweakey[1]      ) & 0xff] & 0xff];
        rtweakey[2] =
            Td0[Te4[(rtweakey[2] >> 24)       ] & 0xff] ^
            Td1[Te4[(rtweakey[2] >> 16) & 0xff] & 0xff] ^
            Td2[Te4[(rtweakey[2] >>  8) & 0xff] & 0xff] ^
            Td3[Te4[(rtweakey[2]      ) & 0xff] & 0xff];
        rtweakey[3] =
            Td0[Te4[(rtweakey[3] >> 24)       ] & 0xff] ^
            Td1[Te4[(rtweakey[3] >> 16) & 0xff] & 0xff] ^
            Td2[Te4[(rtweakey[3] >>  8) & 0xff] & 0xff] ^
            Td3[Te4[(rtweakey[3]      ) & 0xff] & 0xff];
    }
    return Nr;
}
...
void aesTweakEncrypt(uint32_t tweakey_size,
    ...
    Nr=deoxysKeySetupEnc256 (rk, key, tweakey_size/128);
                     ...
                     uint8_t pt[16])
{
    ...
    /* Produce the round tweakeys */
    Nr=deoxysKeySetupDec256 (rk, key, tweakey_size/128);
