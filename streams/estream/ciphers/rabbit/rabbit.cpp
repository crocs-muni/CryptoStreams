...
static void RABBIT_next_state(RABBIT2_ctx* p_instance) {
    /* Temporary variables */
    u32 g[8], c_old[8], i;
...
void ECRYPT_Rabbit::ECRYPT_init(void) {
    return;
}
...
/* Key setup */
void ECRYPT_Rabbit::ECRYPT_keysetup(const u8* key, u32 keysize, u32 ivsize) {
    RABBIT_ctx* ctx = &_ctx;
    /* Temporary variables */
    u32 k0, k1, k2, k3, i;
...
/* IV setup */
void ECRYPT_Rabbit::ECRYPT_ivsetup(const u8* iv) {
    RABBIT_ctx* ctx = &_ctx;
    /* Temporary variables */
    u32 i0, i1, i2, i3, i;
...
void ECRYPT_Rabbit::RABBIT_process_bytes(
        int action, void* ctxa, const u8* input, u8* output, u32 msglen) {
    RABBIT_ctx* ctx = (RABBIT_ctx*)ctxa;
    /* Temporary variables */
    u32 i;
    u8 buffer[16];
...
/* Generate keystream */
void ECRYPT_Rabbit::RABBIT_keystream_bytes(RABBIT_ctx* ctx, u8* keystream, u32 length) {
    /* Temporary variables */
    u32 i;
    u8 buffer[16];
...
void ECRYPT_Rabbit::RABBIT_process_blocks(
        int action, RABBIT_ctx* ctx, const u8* input, u8* output, u32 blocks) {
    /* Temporary variables */
    u32 i;
...
void ECRYPT_Rabbit::ECRYPT_encrypt_bytes(const u8* plaintext, u8* ciphertext, u32 msglen) {
    RABBIT_process_bytes(0, &_ctx, plaintext, ciphertext, msglen);
}
