...
EnruptHashReturn EnRUPTu##W##_##h (enruptHashState *state, const EnruptBitSequence *data, EnruptDataLength databitlen)\
{\
...
EnruptHashReturn EnRUPTf##W##_##h (enruptHashState *state, EnruptBitSequence *hashval)\
{\
...
EnruptHashReturn Init (enruptHashState *state, int hashbitlen) { EnRUPT_Init(state) return ENRUPT_SUCCESS; }
EnruptHashReturn Update (enruptHashState *state, const EnruptBitSequence *data, EnruptDataLength databitlen) { return state->u (state, data, databitlen); }
EnruptHashReturn Final (enruptHashState *state, EnruptBitSequence *hashval) { return state->f (state, hashval); }
EnruptHashReturn Hash (int hashbitlen, const EnruptBitSequence *data, EnruptDataLength databitlen, EnruptBitSequence *hashval) { enruptHashState state; EnRUPT_Init(&state) state.u (&state, data, databitlen); return state.f (&state, hashval); }
