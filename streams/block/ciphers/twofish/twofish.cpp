...
static unsigned TWOFISH_N_ROUNDS = 16;
...
void twofish_decrypt(const u4byte in_blk[4], u4byte out_blk[4], unsigned rounds)
{   u4byte  t0, t1, blk[4];
    TWOFISH_N_ROUNDS = rounds;
