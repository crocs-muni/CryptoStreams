...
//}
//
//block LowMC::MultiplyWithGF2Matrix(const std::vector<block> matrix, const block message) {
//    block temp = 0;
//    for (unsigned i = 0; i < blocksize; ++i) {
...
//}
//
//block LowMC::MultiplyWithGF2Matrix_Key(const std::vector<keyblock> matrix, const keyblock k) {
//    block temp = 0;
//    for (unsigned i = 0; i < blocksize; ++i) {
...
unsigned int LowMCBase::getNumofboxes() const {
    return numofboxes;
}
unsigned int LowMCBase::getRounds() const {
    return rounds;
}
unsigned int LowMCBase::getOrigKeysize() const {
    return orig_keysize;
}
unsigned int LowMCBase::getOrigBlocksize() const {
    return orig_blocksize;
}
unsigned int LowMCBase::getKeysize() const {
    return keysize;
}
unsigned int LowMCBase::getBlocksize() const {
    return blocksize;
}
}}