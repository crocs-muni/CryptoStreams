 ...
 * KASUMI Encryption
 */
 void KASUMI::encrypt_n(const uint8_t in[], uint8_t out[], size_t blocks, unsigned int rounds) const
    {
 ...
 * KASUMI Decryption
 */
 void KASUMI::decrypt_n(const uint8_t in[], uint8_t out[], size_t blocks, unsigned int rounds) const
    {
    //verify_key_set(m_EK.empty() == false);
 ...
 */
 void KASUMI::key_schedule(const uint8_t key[], size_t)
    ...
    std::vector<uint16_t> K(16); //secure_vector
