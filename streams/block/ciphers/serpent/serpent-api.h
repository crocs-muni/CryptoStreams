...
const unsigned SERPENT_MAX_ROUNDS = 32; /* max # of rounds */
...
#define WORDS_PER_KEY_SCHEDULE ((serpent_n_rounds+1)*WORDS_PER_BLOCK)
...
typedef WORD keySchedule[SERPENT_MAX_ROUNDS+1][WORDS_PER_BLOCK];
