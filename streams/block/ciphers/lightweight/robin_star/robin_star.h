...
#ifndef CRYPTO_STREAMS_ROBIN_STAR_H
#define CRYPTO_STREAMS_ROBIN_STAR_H

#include <streams/block/ciphers/lightweight/lightweight.h>
#include <streams/block/ciphers/lightweight/common/cipher.h>

#define LBOX_WORD RAM_DATA_WORD
#define READ_LBOX_WORD READ_RAM_DATA_WORD
...
#define ROBIN_STAR_BLOCK_SIZE 16

#define ROBIN_STAR_KEY_SIZE 16
#define ROBIN_STAR_ROUND_KEYS_SIZE 16

#define ROBIN_STAR_NUMBER_OF_ROUNDS 16

namespace block {

    class robin_star : public lightweight<ROBIN_STAR_ROUND_KEYS_SIZE, ROBIN_STAR_BLOCK_SIZE> {
        /*
         *
         * Cipher constants
         *
    ...
    public:
        robin_star(size_t rounds) : lightweight(rounds) {}
