...
#ifndef CRYPTO_STREAMS_ROBIN_H
#define CRYPTO_STREAMS_ROBIN_H
...
#define ROBIN_BLOCK_SIZE 16

#define ROBIN_KEY_SIZE 16
#define ROBIN_ROUND_KEYS_SIZE 16

#define ROBIN_NUMBER_OF_ROUNDS 16

namespace block {

    class robin : public lightweight<ROBIN_ROUND_KEYS_SIZE, ROBIN_BLOCK_SIZE> {
        /*
         *
         * Cipher constants
         *
    ...
    public:
        robin(size_t rounds) : lightweight(rounds) {}
