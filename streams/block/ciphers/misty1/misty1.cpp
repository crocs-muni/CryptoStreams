...
namespace Botan {
    ...
    * MISTY1 Encryption
    */
    void MISTY1::encrypt_n(const uint8_t in[], uint8_t out[], size_t blocks, unsigned int rounds) const
    {
    ...
    * MISTY1 Decryption
    */
    void MISTY1::decrypt_n(const uint8_t in[], uint8_t out[], size_t blocks, unsigned int rounds) const
    {
